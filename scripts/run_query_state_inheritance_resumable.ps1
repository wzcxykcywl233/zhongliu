...
param(
    ...
    [string]$ResultsRoot = 'C:\zhongliu\zhongliu-tuning\protocol-40-10-38\query-state-inheritance',
...
& (Join-Path $RepoRoot 'scripts\run_memory_refinement_resumable.ps1') `
    ...
    -ManifestRelative 'cotracker-algorithm\experiments\query-state-40-10-38.json' `
    -ResultPrefix 'query-state'
