...
param(
    ...
    [string]$ResultsRoot = 'C:\zhongliu\zhongliu-tuning\protocol-40-10-38\rotation-backcheck',
...
& (Join-Path $RepoRoot 'scripts\run_memory_refinement_resumable.ps1') `
    ...
    -ManifestRelative 'cotracker-algorithm\experiments\rotation-backcheck-40-10-38.json' `
    -ResultPrefix 'rotation-backcheck'
