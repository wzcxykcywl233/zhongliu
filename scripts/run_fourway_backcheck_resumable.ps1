...
param(
    ...
    [string]$ResultsRoot = 'C:\zhongliu\zhongliu-tuning\protocol-40-10-38\fourway-backcheck',
...
& (Join-Path $RepoRoot 'scripts\run_memory_refinement_resumable.ps1') `
    ...
    -ManifestRelative 'cotracker-algorithm\experiments\fourway-backcheck-40-10-38.json' `
    -ResultPrefix 'fourway-backcheck'
